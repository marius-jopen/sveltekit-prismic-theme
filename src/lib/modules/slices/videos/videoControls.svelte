...
<div on:mousemove={HideControls} on:mousemove={unHideControls} class="relative w-full" >
	...
	<div class:hideControlsSoft="{hideControl === true}" class="opacity-100 transition-opacity h-8 absolute bottom-0 bg-white w-full z-10 px-4 text-lg pt-1 flex justify-between">
		<div class="flex">
