<script>
    ...
    export let inputText // Input the string and not the array
...
<div class="border-b border-lines">
	...
	<Text text={text} hasRichtext={false} classes={'px-4 py-2 text-xl uppercase text-center'} classesRichtext={''}/>
</div>