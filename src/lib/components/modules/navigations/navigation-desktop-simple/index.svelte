...
<div class="{height} hidden sm:flex fixed w-full z-50 justify-between px-4 border-b border-lines bg-background">
    <a data-sveltekit-prefetch class="textHoverGrey" href="/">
    ...
    <div>
		{#each data.navigation_top as navItem}
			{#if navItem.uid[0]}
				<a data-sveltekit-prefetch class="ml-4 text-lg textHoverGrey" href="/{navItem.uid[0].text}">
