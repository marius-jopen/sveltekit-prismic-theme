...
<div class="relative">
	...
	{#if totalSlides > 1}
		<div on:click={prevSlide} class="-mt-6 absolute top-0 left-0 w-1/2 p-1 cursor-pointer z-10 h-full hidden sm:flex justify-center flex-col sm:opacity-0 hover:opacity-100 transition-opacity duration-300">
			<div class="pl-2 flex justify-start">
				<svg class="h-2 sm:h-6 rotate-180" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.53 20.05"><defs><style>.cls-1{fill:none;stroke:white;stroke-miterlimit:10;stroke-width:2px;}</style></defs><g id="Ebene_2" data-name="Ebene 2"><g id="Ebene_1-2" data-name="Ebene 1"><line class="cls-1" y1="10.02" x2="29.95" y2="10.02"/><polyline class="cls-1" points="20.8 19.34 30.12 10.02 20.8 0.71"/></g></g></svg>
			</div>
		</div>

		<div on:click={nextSlide} class="-mt-6 absolute top-0 right-0 w-1/2 p-1 cursor-pointer z-10 h-full hidden sm:flex justify-center flex-col sm:opacity-0 hover:opacity-100 transition-opacity duration-300">
			<div class="pr-2 flex justify-end">
				<svg class="h-2 sm:h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.53 20.05"><defs><style>.cls-1{fill:none;stroke:white;stroke-miterlimit:10;stroke-width:2px;}</style></defs><g id="Ebene_2" data-name="Ebene 2"><g id="Ebene_1-2" data-name="Ebene 1"><line class="cls-1" y1="10.02" x2="29.95" y2="10.02"/><polyline class="cls-1" points="20.8 19.34 30.12 10.02 20.8 0.71"/></g></g></svg>
			</div>
		</div>
	{/if}
