...
Modules that displays all projects / items as accordeons in a list:
- Live search through all items
- Accordeon items
- Close all others when one accordeon opens
- Sort items
- URL change when an accordeon opens
- Open an accordeon item when the user opens an URL which has a "#test" included
